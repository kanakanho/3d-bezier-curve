...
let (bestSegments3D, cubicCurves3D) = findBestSegments3D(points: input3D, maxSegments: 100, errorThreshold: 0.001)
// let cubicCurves3D = segmentedCubicBezierFit3D(points: input3D, segments: bestSegments3D)
print("[3D] 自動決定されたセグメント数: \(bestSegments3D)")
